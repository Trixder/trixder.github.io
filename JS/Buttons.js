    ...
    switch (placedBuildings[nearBuilding][2]) {
        case 1:
            if (coins >= (175 * placedBuildings[nearBuilding][3]) && placedBuildings[nearBuilding][3] < 5) {
                ...
                console.log(placedBuildings[nearBuilding][3], placedBuildings[nearBuilding][4]);
            }
            break;
        case 2:
        ...
        case 3:
            if (placedBuildings[nearBuilding][1] <= 400 && coins >= 150) {
                ...
                console.log(placedBuildings[nearBuilding][1]);
            }
            break;
        case 4:
...
function NewWave() {
    if (!spawning && enemyArr.length == 0 && enemies == 0) {
        wave++;
        spawning = true;
        enemies = Math.round(Math.tan(wave / 100) * 100);
    }
}
    ...
    if (!col) {
        switch (selectedBuilding){
            case (buildings[0]):
                if (coins >= 75) {
                    coins -= 75;
                    let bow = app.stage.addChildAt(PlaceSprite("./IMG/bow.png", Player.x - Player.width / 2 + blockSize, Player.y - blockSize / 2, blockSize, blockSize, -1, 0), buildHere);
            ...
            case (buildings[1]):
                if (coins >= 50) {
                    coins -= 50;
                    let sword = app.stage.addChildAt(PlaceSprite("./IMG/sword.png", Player.x - Player.width / 2 + blockSize, Player.y - blockSize / 2, blockSize, blockSize, -1, 0), buildHere);
            ...
            case (buildings[2]):
                if (coins >= 75) {
                    coins -= 75;
                    let shield = app.stage.addChildAt(PlaceSprite("./IMG/shield.png", Player.x - Player.width / 2 + blockSize, Player.y - blockSize / 2, blockSize, blockSize, -1, 0), buildHere);
            ...
            case (buildings[3]):
                if (coins >= 25) {
                    coins -= 25;
                    let coin = app.stage.addChildAt(PlaceSprite("./IMG/coin.png", Player.x - Player.width / 2 + blockSize, Player.y - blockSize / 2, blockSize, blockSize, -1, 0), buildHere);
