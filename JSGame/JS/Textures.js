...
function Textures() {
    ...
    swordTexture = [PIXI.Texture.from('./IMG/spike_lvl1.png'), PIXI.Texture.from('./IMG/spike_lvl1.png'), PIXI.Texture.from('./IMG/spike_lvl2.png'), PIXI.Texture.from('./IMG/spike_lvl3.png'), PIXI.Texture.from('./IMG/spike_lvl4.png'), PIXI.Texture.from('./IMG/spike_lvl5.png')];
